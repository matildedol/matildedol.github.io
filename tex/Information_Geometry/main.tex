...
\include{mati_fdiv}
%\include{matilde}
\include{2ndlecture_mati}
\include{Lisco}
\include{riemannian_geo}
\include{may27}
%---------Bibliography---------
...
% \bibitem[AJVLS]{AJVLS} 
% N. Ay, J. Jost, H. Vân Lê, L. Schwachhöfer. \textit{Information Geometry}, Springer. 2017.

% \bibitem[Niels]{Niels} 
% F. Nielsen. An Elementary Introduction to Information Geometry, \textit{Entropy} 22(10):1100. 2020.

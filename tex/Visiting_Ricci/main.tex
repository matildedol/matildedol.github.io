...
\ifcsname c@proposition\endcsname\else\newtheorem{proposition}[definition]{Proposition}\fi
\ifcsname c@theorem\endcsname\else\newtheorem{theorem}[definition]{Theorem}\fi
\ifcsname c@corollary\endcsname\else\newtheorem{corollary}[definition]{Corollary}\fi
\ifcsname c@lemma\endcsname\else\newtheorem{lemma}[definition]{Lemma}\fi
\makeatother
...
\begin{document}
\maketitle
This is a collection of notes on the study behind the topic of \textit{Ricci Curvature of Finite Markov Chains}, Erbar and Maas (2011), Erbar and Fathi (2016). 
\\
...
\section{Heat flow as grad flow of energy functionals}\label{sec: heat flow antropy}

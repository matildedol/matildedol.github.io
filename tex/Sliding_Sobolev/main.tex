...
\section{Synthetic geometric structure}
\tableofcontents[currentsection]
\subsection{Setup}
\begin{frame}{Setup}
...
\pause[]
\bigskip
Many implications on convergence property, spectrum of the Laplacian and hypercontractivity!

\bigskip\centering
{\color{blue}  $\star$ Our focus: how MLSI allows to bound the mixing time of the chain via entropy decay  $\star$ }
\end{frame}
